...
*/
{
  std::cout << "Simulation has concluded after " << time << " time units."
            ...
            << "Total number of planes that landed " << num_landings
            << std::endl
            << "Total number of planes that took off " << num_takeoffs
            << std::endl
            << "Total number of planes left in landing queue " << landing.size()
            << std::endl
            << "Total number of planes left in takeoff queue " << takeoff.size()
            << std::endl;
  ...
  std::cout << std::endl
            ...
            << ((float)takeoff_wait) / ((float)num_takeoffs) << " time units"
            << std::endl;
  std::cout << "Average observed rate of planes wanting to land "
            << ((float)num_land_requests) / ((float)time) << " per time unit"
            << std::endl;
